...
var p = {
    ...
    h = a && typeof a.apply == "function" ? a.apply : function (e, n, r) {
...
o.prototype.emit = function (e) {
    ...
    if (typeof c == "function") h(c, this, n);
        ...
        for (var d = c.length, O = E(c, d), r = 0; r < d; ++r) h(O[r], this, n);
    return !0
};
...
o.prototype.removeListener = function (e, n) {
    ...
    if (r === n || r.listener === n) --this._eventsCount === 0 ? this._events = Object.create(null) : (delete i[e], i.removeListener && this.emit("removeListener", e, r.listener || n));
        ...
        f === 0 ? r.shift() : P(r, f), r.length === 1 && (i[e] = r[0]), i.removeListener !== void 0 && this.emit("removeListener", e, u || n)
    }
    return this
};
...
function w(t, e, n) {
    ...
    if (r === void 0) return [];
    var i = r[e];
    return i === void 0 ? [] : typeof i == "function" ? n ? [i.listener || i] : [i] : n ? T(i) : E(i, i.length)
}
